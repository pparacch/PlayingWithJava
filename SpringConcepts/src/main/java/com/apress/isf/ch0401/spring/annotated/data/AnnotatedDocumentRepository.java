package com.apress.isf.ch0401.spring.annotated.data;
...
public class AnnotatedDocumentRepository implements DocumentDAO {
	...
	private static Logger logger = Logger.getLogger("com.apress.isf.ch0401.spring.annotated.data");
	
	public AnnotatedDocumentRepository(){
		logger.log(Level.INFO, "AnnotatedDocumentRepository created: " + this);
	}
